export const initGradientMan = (interval = 16) => {
  ...
  setInterval(() => {
    ...
    roto1 = roto1 - 2 // rotation // Math.round(roto1)
    roto2 = roto2 + 0.5 // rotation // Math.round(roto2)
    hsla1 = `hsla(${roto1}, 100%, 60%, 0.6)`;
    hsla2 = `hsla(${roto2}, 80%, 40%, 0.7)`;
    bgString = `linear-gradient(${rotation+77}deg, ${hsla1} ${30}%, ${hsla2} ${90}%)`
